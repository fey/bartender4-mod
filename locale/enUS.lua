...
L["Hide the Reputation Bar when no faction is watched."] = true
...
L["Show rested XP text on the XP Bar."] = true
L["Show text on the Reputation Bar."] = true
L["Show text on the XP Bar."] = true
L["Show/Hide"] = true
...
L["Enable Snapping"] = true
L["Snap Distance"] = true
L["Center Snap Distance"] = true
L["Snap Padding"] = true
L["Clamp to Screen"] = true
L["Enable snapping while dragging."] = true
L["Distance in pixels used for edge snapping."] = true
L["Distance in pixels used for center alignment snapping."] = true
L["Additional gap between bars when edge snapping."] = true
L["Keep bar inside screen bounds while moving."] = true
