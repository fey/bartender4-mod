...
L["Show text on the XP Bar."] = "Показывать текст на полосе опыта."
L["Show text on the Reputation Bar."] = "Показывать текст на полосе репутации."
L["Show Rested"] = "Показывать отдых"
L["Show rested XP text on the XP Bar."] = "Показывать информацию об отдыхе на полосе опыта."
L["Auto Hide"] = "Автоскрытие"
L["Hide the Reputation Bar when no faction is watched."] = "Скрывать полосу репутации, если не выбрана фракция для отслеживания."
L["Zoom"] = "Увеличение"
...
L["Enable Snapping"] = "Включить прилипание"
L["Snap Distance"] = "Дистанция прилипания"
L["Center Snap Distance"] = "Дистанция центрирования"
L["Snap Padding"] = "Зазор прилипания"
L["Clamp to Screen"] = "Ограничивать экраном"
L["Enable snapping while dragging."] = "Включить прилипание во время перетаскивания."
L["Distance in pixels used for edge snapping."] = "Дистанция в пикселях для прилипания по краям."
L["Distance in pixels used for center alignment snapping."] = "Дистанция в пикселях для центрирования панелей."
L["Additional gap between bars when edge snapping."] = "Дополнительный зазор между панелями при прилипании по краям."
L["Keep bar inside screen bounds while moving."] = "Не позволять панели выходить за границы экрана при перемещении."
